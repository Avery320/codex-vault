...
// - "___COMET_ALIAS_DIVIDER___" - underscores interpreted as emphasis markers
// - "COMET__INTERNAL__..." - double underscores cause strong emphasis issues
// - "COMETINTERNALALIASDIVIDERPLACEHOLDER" - gets truncated (output: "[[noteCOMETINTERN")
...
export const escapeWikilinkPipes = (md: MarkdownIt) => {
  ...
  // so the other Comet inline plugins (wikilink embed/navigation) see
